class PokeBattle_AI
  ...
  def pbEnemyItemToUse(idxBattler)
    ...
    oneStatusItems = [   # Preferred over items that heal all status problems
       :AWAKENING,:MINTBERRY,:BLUEFLUTE,
       :ANTIDOTE,:PSNCUREBERRY,
       :BURNHEAL,:ICEBERRY,
       :PARALYZEHEAL,:PARLYZHEAL,:PRZCUREBERRY,
       :ICEHEAL,:BURNTBERRY
    ]
    allStatusItems = [
       :FULLHEAL,:LAVACOOKIE,:OLDGATEAU,:CASTELIACONE,:LUMIOSEGALETTE,
       :SHALOURSABLE,:BIGMALASADA,:MIRACLEBERRY,:HEALPOWDER
    ]
