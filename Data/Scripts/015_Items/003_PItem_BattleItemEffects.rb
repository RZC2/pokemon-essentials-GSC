...
ItemHandlers::CanUseInBattle.copy(:POTION,
   ...
   :SODAPOP,:LEMONADE,:MOOMOOMILK,:BERRY,:GOLDBERRY,:ENERGYPOWDER,
   :ENERGYROOT)
...
ItemHandlers::CanUseInBattle.copy(:AWAKENING,:MINTBERRY)
...
ItemHandlers::CanUseInBattle.copy(:ANTIDOTE,:PSNCUREBERRY)
...
ItemHandlers::CanUseInBattle.copy(:BURNHEAL,:ICEBERRY)
...
ItemHandlers::CanUseInBattle.copy(:PARALYZEHEAL,:PARLYZHEAL,:PRZCUREBERRY)
...
ItemHandlers::CanUseInBattle.copy(:ICEHEAL,:BURNTBERRY)
...
ItemHandlers::CanUseInBattle.copy(:FULLHEAL,
   ...
   :BIGMALASADA,:MIRACLEBERRY,:HEALPOWDER)
...
ItemHandlers::CanUseInBattle.add(:BITTERBERRY,proc { |item,pokemon,battler,move,firstAction,battle,scene,showMessages|
...
ItemHandlers::BattleUseOnPokemon.add(:BERRY,proc { |item,pokemon,battler,choices,scene|
  pbBattleHPItem(pokemon,battler,10,scene)
})

ItemHandlers::BattleUseOnPokemon.add(:GOLDBERRY,proc { |item,pokemon,battler,choices,scene|
...
ItemHandlers::BattleUseOnPokemon.copy(:AWAKENING,:MINTBERRY,:BLUEFLUTE)
...
ItemHandlers::BattleUseOnPokemon.copy(:ANTIDOTE,:PSNCUREBERRY)
...
ItemHandlers::BattleUseOnPokemon.copy(:BURNHEAL,:ICEBERRY)
...
ItemHandlers::BattleUseOnPokemon.copy(:PARALYZEHEAL,:PARLYZHEAL,:PRZCUREBERRY)
...
ItemHandlers::BattleUseOnPokemon.copy(:ICEHEAL,:BURNTBERRY)
...
ItemHandlers::BattleUseOnBattler.copy(:YELLOWFLUTE,:BITTERBERRY)
